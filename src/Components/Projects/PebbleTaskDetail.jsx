          ...
          <div className="image-description-section">
            <div className="image-description-block">
              ...
              <div className="desc-image">
                <img src="/portfolio/assets/project/PebbleTask/PebbleTask-desc-1.png" alt="PebbleTask Description 1" style={{ width: '600px' }} />
              </div>
            ...
            <div className="image-description-block">
              ...
              <div className="desc-image">
                <img src="/portfolio/assets/project/PebbleTask/PebbleTask-desc-2.png" alt="PebbleTask Description 2" style={{ width: '800px' }} />
              </div>
              <div className="description" style={{ textAlign: 'left' }}>
