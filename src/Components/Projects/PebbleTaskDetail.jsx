    ...
    <main className="main-content">
      <div className="project-detail-container">
            ...
            <div className="image-description-section">
              <div className="image-description-block">
                ...
                <div className="desc-image project-detail-image-wrapper">
                  <img src="/assets/project/PebbleTask/PebbleTask-desc-1.png" alt="PebbleTask Description 1" style={{ width: '600px' }} onClick={() => handleImageClick("/assets/project/PebbleTask/PebbleTask-desc-1.png")} />
                </div>
              ...
              <div className="image-description-block">
                ...
                <div className="desc-image project-detail-image-wrapper">
                  <img src="/assets/project/PebbleTask/PebbleTask-desc-2.png" alt="PebbleTask Description 2" style={{ width: '800px' }} onClick={() => handleImageClick("/assets/project/PebbleTask/PebbleTask-desc-2.png")} />
                </div>
                <div className="description" style={{ textAlign: 'left' }}>
        ...
        {modalOpen && (
          <ImageModal
            src={selectedImage}
            alt={`Expanded image for PebbleTask`}
            onClose={closeModal}
          />
        )}
      </div>
