          ...
          <div className="image-description-section">
            <div className="image-description-block">
              ...
              <div className="desc-image">
                <img src="/portfolio/assets/project/OverGrown/OverGrown-desc-1.png" alt="OverGrown Description 1" style={{ width: '600px' }} />
              </div>
            ...
            <div className="image-description-block">
              ...
              <div className="desc-image">
                <img src="/portfolio/assets/project/OverGrown/OverGrown-desc-2.png" alt="OverGrown Description 2" style={{ width: '800px' }} />
              </div>
              <div className="description" style={{ textAlign: 'left' }}>
            ...
            <div className="image-description-block">
              ...
              <div className="desc-image">
                <img src="/portfolio/assets/project/OverGrown/OverGrown-desc-3.png" alt="OverGrown Description 3" style={{ width: '800px' }} />
              </div>
              <div className="description" style={{ textAlign: 'left' }}>
              ...
              <div className="desc-image">
                <img src="/portfolio/assets/project/OverGrown/OverGrown-desc-4.png" alt="OverGrown Description 4" style={{ width: '800px' }} />
              </div>
              <div className="description" style={{ textAlign: 'left' }}>
