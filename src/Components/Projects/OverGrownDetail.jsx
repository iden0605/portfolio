  ...
  return (
    <main className="main-content">
            ...
            <div className="image-description-section">
              <div className="image-description-block">
                ...
                <div className="desc-image project-detail-image-wrapper">
                  <img src="/assets/project/OverGrown/OverGrown-desc-1.png" alt="OverGrown Description 1" style={{ width: '600px' }} onClick={() => handleImageClick("/assets/project/OverGrown/OverGrown-desc-1.png")} />
                </div>
              ...
              <div className="image-description-block">
                ...
                <div className="desc-image project-detail-image-wrapper">
                  <img src="/assets/project/OverGrown/OverGrown-desc-2.png" alt="OverGrown Description 2" style={{ width: '800px' }} onClick={() => handleImageClick("/assets/project/OverGrown/OverGrown-desc-2.png")} />
                </div>
                <div className="description" style={{ textAlign: 'left' }}>
              ...
              <div className="image-description-block">
                ...
                <div className="desc-image project-detail-image-wrapper">
                  <img src="/assets/project/OverGrown/OverGrown-desc-3.png" alt="OverGrown Description 3" style={{ width: '800px' }} onClick={() => handleImageClick("/assets/project/OverGrown/OverGrown-desc-3.png")} />
                </div>
                <div className="description" style={{ textAlign: 'left' }}>
                ...
                <div className="desc-image project-detail-image-wrapper">
                  <img src="/assets/project/OverGrown/OverGrown-desc-4.png" alt="OverGrown Description 4" style={{ width: '800px' }} onClick={() => handleImageClick("/assets/project/OverGrown/OverGrown-desc-4.png")} />
                </div>
                <div className="description" style={{ textAlign: 'left' }}>
      ...
      {modalOpen && (
        <ImageModal
          src={selectedImage}
          alt={`Expanded image for OverGrown`}
          onClose={closeModal}
        />
      )}
    </main>
