    ...
    <footer className="footer">
      <div className="footer-links">
        <a href={githubLink} target="_blank" rel="noopener noreferrer" className="footer-icon">
          <img src="/assets/logo/Github-white-logo.png" alt="GitHub Logo" className="social-icon"/>
        </a>
        <a href={linkedinLink} target="_blank" rel="noopener noreferrer" className="footer-icon">
          <img src="/assets/logo/LinkedIn-logo.png" alt="LinkedIn Logo" className="social-icon"/>
        </a>
        <a href={gmailLink} target="_blank" rel="noopener noreferrer" className="footer-icon">
          <img src="/assets/logo/Gmail-logo.png" alt="Gmail Logo" className="social-icon"/>
        </a>
      </div>
    </footer>
  );
